 ...
 * @returns {Promise<{postUrl: string, imageUrl: string|null}>} - The URL of the published post and uploaded image
 */
export async function publishToMainSite(item) {
    ...
    try {
        ...
        // Return both post URL and uploaded image URL
        return {
 ...
 * If wordpressImageUrl is available, reuses it instead of re-uploading.
 * @param {object} item - News item to publish
