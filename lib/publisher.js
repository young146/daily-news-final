...
<div class="news-source-header">
    <div><strong>📰 출처:</strong> ${sourceName} | ${dateStr}</div>
    ${item.originalUrl ? `<a href="${item.originalUrl}" target="_blank" rel="noopener noreferrer" class="news-source-link-btn">🌐 원문 기사 전체 보기</a>` : ''}
</div>`;
}
