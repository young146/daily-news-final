...
const BASELINE = {
  Economy: ['베트남 환율', '동 환율', '베트남 최저임금', '베트남 경제', '베트남 물가', '베트남 주식', '베트남 투자'],
  'Real Estate': ['베트남 부동산', '하노이 아파트', '호찌민 부동산', '베트남 집값', '베트남 아파트'],
  Travel: ['다낭 여행', '나트랑 여행', '푸꾸옥 여행', '하노이 여행', '호이안 여행', '달랏 여행', '베트남 여행', '베트남 항공권'],
  Food: ['베트남 쌀국수', '반미', '분짜', '베트남 음식', '베트남 커피'],
  Society: ['베트남 뉴스', '베트남 사건', '베트남 날씨', '베트남 사회'],
  Politics: ['베트남 정치', '베트남 총리', '베트남 정책', '베트남 정부'],
  International: ['베트남 미국', '베트남 중국', '베트남 관세'],
  'Korea-Vietnam': ['베트남 비자', '베트남 취업', '베트남 한인', '한베', '베트남 진출기업'],
  Community: ['베트남 교민', '하노이 한인', '호찌민 한인', '베트남 한인회', '베트남 코참'],
