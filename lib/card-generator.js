...
export async function generateCardImageBuffer({
  ...
  // 날씨 및 환율 (이모지 대신 텍스트 사용, 특수기호 제거)
  ctx.fillStyle = '#4b5563';
  ctx.font = '18px "NanumGothic", sans-serif';
  ctx.fillText(`서울 기온: ${weatherTemp}C`, 650, 555);
  ctx.fillText(`USD 환율: ${usdRate} VND`, 820, 555);
  ctx.fillText(`KRW 환율: ${krwRate} VND`, 1000, 555);
