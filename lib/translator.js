...
import { formatKeywordHint } from './popular-keywords.js';
...
- Naturally weave the single most relevant keyword (seoKeywords[0]) into translatedTitle IF it fits smoothly. Never force it — an awkward or misleading title is worse than no keyword.
- **PROHIBITED:** clickbait, exaggeration, keyword stuffing, or any keyword NOT supported by the article's actual content. Truthfulness overrides SEO.
