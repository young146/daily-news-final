...
**CRITICAL: Proper noun rules (STRICTLY FOLLOW)**
1. Foreign names: "도널드 트럼프(Donald Trump)", "엘론 머스크(Elon Musk)"
2. Foreign places: "워싱턴(Washington)", "런던(London)", "도쿄(Tokyo)"
3. Organizations: "세계보건기구(WHO)", "구글(Google)", "테슬라(Tesla)"
4. **VIETNAMESE proper nouns - ALWAYS include Vietnamese original**:
   - Names: "응우옌쑤언푹(Nguyễn Xuân Phúc)", "팜민찐(Phạm Minh Chính)"
   - Places: "하노이(Hà Nội)", "호찌민(Hồ Chí Minh)", "다낭(Đà Nẵng)", "메콩델타(Mekong Delta)", "닌빈성(Ninh Bình)"
   - Companies: "빈그룹(VinGroup)", "빈패스트(VinFast)", "비엣젯(VietJet)"
5. Keep Korean names as-is: "박항서", "서울", "문재인"
6. **Currency - ALWAYS show original amount in parentheses**:
   - "1억 동(100 million VND)", "50만 달러(500,000 USD)", "1000억 동(100 billion VND)"
    ...
    **Korean News Style Guidelines:**
    ...
    - "translatedTitle": 
      ...
      * **CRITICAL: For ALL proper nouns, include original in parentheses**
        - Foreign: "도널드 트럼프(Donald Trump)", "워싱턴(Washington)", "세계보건기구(WHO)"
        - **VIETNAMESE - MUST include**: "응우옌쑤언푹(Nguyễn Xuân Phúc)", "하노이(Hà Nội)", "빈그룹(VinGroup)"
        - Korean names as-is: "박항서", "서울"
    ...
    - "translatedSummary": 
      ...
      * End with "~다", "~했다", "~전망이다"
      * **ALL proper nouns with original**: Foreign "도널드 트럼프(Donald Trump)", VIETNAMESE "팜민찐(Phạm Minh Chính)"
      * **Currency with original**: "1억 동(100 million VND)"
    ...
    - "translatedContent": 
      ...
      * **CRITICAL: ALL proper nouns MUST include original in parentheses**
        - Foreign: "도널드 트럼프(Donald Trump)", "워싱턴(Washington)", "세계보건기구(WHO)"
        - **VIETNAMESE (VERY IMPORTANT)**: "응우옌쑤언푹(Nguyễn Xuân Phúc)", "하노이(Hà Nội)", "호찌민(Hồ Chí Minh)", "빈그룹(VinGroup)", "메콩델타(Mekong Delta)"
        - Korean only: "박항서", "서울", "문재인"
      * **Currency MUST show original amount**: "1억 동(100 million VND)", "50만 달러(500,000 USD)", "5000억 동(500 billion VND)"
...
**CRITICAL: Proper noun and currency rules (STRICTLY FOLLOW)**
1. Foreign names: "도널드 트럼프(Donald Trump)", "엘론 머스크(Elon Musk)"
2. Foreign places: "워싱턴(Washington)", "런던(London)"
3. Organizations: "세계보건기구(WHO)", "구글(Google)"
4. **VIETNAMESE proper nouns - ALWAYS include Vietnamese original (VERY IMPORTANT)**:
   - Names: "응우옌쑤언푹(Nguyễn Xuân Phúc)", "팜민찐(Phạm Minh Chính)"
   - Places: "하노이(Hà Nội)", "호찌민(Hồ Chí Minh)", "다낭(Đà Nẵng)", "메콩델타(Mekong Delta)"
   - Companies: "빈그룹(VinGroup)", "빈패스트(VinFast)"
5. Keep Korean names as-is: "박항서", "서울"
6. **Currency - ALWAYS show original amount**: "1억 동(100 million VND)", "50만 달러(500,000 USD)"
...
- Travel: tourism, travel destinations, hotels, travel tips, vacation
- Health: medical news, health information, wellness, healthcare
- Food: food, cuisine, restaurants, recipes, cooking, dining
...
Summary: ${item.summary || ''}`;
  ...
  for (let attempt = 1; attempt <= MAX_RETRIES; attempt++) {
    try {
      ...
      const validCategories = ['Society', 'Economy', 'Culture', 'Politics', 'Policy', 'International', 'Korea-Vietnam', 'Community', 'Travel', 'Health', 'Food'];
...
- Foreign: "도널드 트럼프(Donald Trump)", "워싱턴(Washington)"
- **VIETNAMESE - MUST include**: "응우옌쑤언푹(Nguyễn Xuân Phúc)", "하노이(Hà Nội)", "빈그룹(VinGroup)"
- Korean as-is: "박항서", "서울"
- **Currency**: "1억 동(100 million VND)", "50만 달러(500,000 USD)"
