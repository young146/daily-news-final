...
Title: ${item.title}`
      ...
      const validCategories = ['Society', 'Economy', 'Culture', 'Politics', 'Policy', 'International', 'Korea-Vietnam', 'Community', 'Travel', 'Health', 'Food', 'Pet'];
...
Return JSON:
{
  ...
  "category": "Society/Economy/Culture/Politics/International/Korea-Vietnam/Community/Travel/Health/Food/Pet"
}
...
- Pet: pet news, animal welfare, pet care, pet health, pet adoption, animal stories
