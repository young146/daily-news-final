...
export default async function Image() {
  ...
  const title =
    topNews?.translatedTitle || topNews?.title || "Xin Chao Daily News";
  const summary =
    topNews?.translatedSummary ||
    topNews?.summary ||
    "Vietnam & Korea Daily News Updates";
      ...
      >
        ...
        <div
          style={{
            ...
            height: "100%",
            background:
              "linear-gradient(to bottom, rgba(0,0,0,0.6) 0%, rgba(0,0,0,0.3) 40%, rgba(0,0,0,0.9) 100%)",
          }}
        />
