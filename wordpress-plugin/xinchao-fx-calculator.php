 ...
 *
 * 왜 만들었나 (2026-09-02):
 *   서치콘솔 실측 — chaovietnam.co.kr 은 이미 '환율' 계열 검색어 94개에 노출 6,393회,
 *   평균 4위로 뜨고 있는데 클릭은 17회(CTR 0.1~0.7%)뿐이다. 이유는 명확하다:
 *   환율을 검색한 사람에게 우리가 보여주는 건 '환율이 언급된 뉴스 기사'라서
 *   찾던 숫자가 없다 → 안 누른다. 숫자를 보여주는 페이지를 만들면 이 노출이 클릭이 된다.
 *   (네이버 검색광고 실측으로도 환율·환전·베트남동 계열은 월 116만 검색 규모)
 *
 * 설치:
